  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
        ...
        <div className="absolute right-3 top-3 rounded-lg bg-background/70 px-2 py-1 text-xs text-muted-foreground backdrop-blur">
          {car.year}
        </div>
      </div>
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <div className="flex items-baseline justify-between">
          ...
          <span className="text-xs text-muted-foreground">{car.fuel} · {car.transmission}</span>
        </div>
